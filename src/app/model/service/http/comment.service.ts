...
export class CommentService{
    ...
    deleteComment(commentId : Number) : Observable<HttpResponse<boolean>>{
        return this.httpClient.delete<HttpResponse<boolean>>(`http://localhost:8080/api/comment/delete-comment?id=${commentId}`);
    }
